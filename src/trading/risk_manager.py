...
class RiskManager:
    ...
    def can_open_new_position(self) -> bool:
        ...
        # FIX Фаза 2 + подтверждено в Фазе 3: daily_loss_limit реально блокирует новые позиции
    ...
    # FIX Фаза 3: удалены неиспользуемые методы (dead code)
    # update_after_open и update_after_close больше не нужны